...
Public Class FormMasterBuku
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        Else
            ...
            Else
                Call Koneksi()
                Dim EditData As String = "update tbl_buku set JudulBuku= '" & TextBox2.Text & "', PengarangBuku='" & TextBox3.Text & "', PenerbitBuku='" & TextBox4.Text & "',  StokBuku='" & TextBox6.Text & "' where KodeBuku= '" & TextBox1.Text & "'"
